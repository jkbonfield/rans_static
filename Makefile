...
r4x16: rNx16.c
	$(CC) $(CFLAGS) -DTEST_MAIN $(OMP) -DNX=4 -o $@ $< $(LIBS)
r8x16: rNx16.c
	$(CC) $(CFLAGS) -DTEST_MAIN $(OMP) -DNX=8 -o $@ $< $(LIBS)
r16x16: rNx16.c
	$(CC) $(CFLAGS) -DTEST_MAIN $(OMP) -DNX=16 -o $@ $< $(LIBS)
r32x16: rNx16.c
	$(CC) $(CFLAGS) -DTEST_MAIN $(OMP) -DNX=32 -o $@ $< $(LIBS)

# Custom SIMD versions for specific platforms
r8x16_sse: r8x16_sse.c
	$(CC) $(CFLAGS) -DTEST_MAIN -msse4 $(OMP) -o $@ $< $(LIBS)
r8x16_avx2: r8x16_avx2.c
	$(CC) $(CFLAGS) -DTEST_MAIN -march=core-avx2 $(OMP) -o $@ $< $(LIBS)
r16x16_avx2: r16x16_avx2.c
	$(CC) $(CFLAGS) -DTEST_MAIN -march=core-avx2 $(OMP) -o $@ $< $(LIBS)
r32x16_avx2: r32x16_avx2.c
	$(CC) $(CFLAGS) -DTEST_MAIN -march=core-avx2 $(OMP) -o $@ $< $(LIBS)
r16x16_avx512: r16x16_avx512.c
	$(CC) $(CFLAGS) -DTEST_MAIN -march=knl $(OMP) -o $@ $< $(LIBS)
