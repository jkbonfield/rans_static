...
unsigned char *rans_uncompress_O0_4x16(unsigned char *in, unsigned int in_size,
	...
	*out_size = out_sz;
	...
	__m128i Vv1_128, Vv2_128;

	Vv1_128 = _mm_insert_epi16(Vv1_128, sp[idx[ 0]], 0);
	Vv2_128 = _mm_insert_epi16(Vv2_128, sp[idx[ 8]], 0);
	Vv1_128 = _mm_insert_epi16(Vv1_128, sp[idx[ 1]], 1);
	Vv2_128 = _mm_insert_epi16(Vv2_128, sp[idx[ 9]], 1);
	Vv1_128 = _mm_insert_epi16(Vv1_128, sp[idx[ 2]], 2);
	Vv2_128 = _mm_insert_epi16(Vv2_128, sp[idx[10]], 2);
	Vv1_128 = _mm_insert_epi16(Vv1_128, sp[idx[ 3]], 3);
	Vv2_128 = _mm_insert_epi16(Vv2_128, sp[idx[11]], 3);
	Vv1_128 = _mm_insert_epi16(Vv1_128, sp[idx[ 4]], 4);
	Vv2_128 = _mm_insert_epi16(Vv2_128, sp[idx[12]], 4);
	Vv1_128 = _mm_insert_epi16(Vv1_128, sp[idx[ 5]], 5);
	Vv2_128 = _mm_insert_epi16(Vv2_128, sp[idx[13]], 5);
	Vv1_128 = _mm_insert_epi16(Vv1_128, sp[idx[ 6]], 6);
	Vv2_128 = _mm_insert_epi16(Vv2_128, sp[idx[14]], 6);
	Vv1_128 = _mm_insert_epi16(Vv1_128, sp[idx[ 7]], 7);
	Vv2_128 = _mm_insert_epi16(Vv2_128, sp[idx[15]], 7);
	__m256i Vv1 = _mm256_cvtepu16_epi32(Vv1_128);
	__m256i Vv2 = _mm256_cvtepu16_epi32(Vv2_128);
#endif
